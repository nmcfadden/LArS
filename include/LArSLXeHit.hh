...
class LArSLXeHit: public G4VHit
{
public:
	LArSLXeHit();
	~LArSLXeHit();
	LArSLXeHit(const LArSLXeHit &);
	const LArSLXeHit & operator=(const LArSLXeHit &);
	G4int operator==(const LArSLXeHit &) const;
...
typedef G4THitsCollection<LArSLXeHit> LArSLXeHitsCollection;

extern G4Allocator<LArSLXeHit> LArSLXeHitAllocator;

inline void*
LArSLXeHit::operator new(size_t)
{
	return((void *) LArSLXeHitAllocator.MallocSingle());
}

inline void
LArSLXeHit::operator delete(void *pLArSLXeHit)
{
	LArSLXeHitAllocator.FreeSingle((LArSLXeHit*) pLArSLXeHit);
}
