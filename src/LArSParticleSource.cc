...
LArSParticleSource::LArSParticleSource()
{
	...
	m_pMessenger = new LArSParticleSourceMessenger(this);
...
void
LArSParticleSource::SetEnergyFile(G4String hEnergyFile)
{
...
G4bool
LArSParticleSource::ReadEnergySpectrum()
{
	...
	if(hEnergyUnit == "eV")
        ...
        dFactor = 0;
        G4cout << "Error: unknown energy unit!" << G4endl;
        return false;
    }
...
void
LArSParticleSource::SetParticleDefinition(G4ParticleDefinition * aParticleDefinition)
{
...
void
LArSParticleSource::ConfineSourceToVolume(G4String hVolumeList)
{
...
void
LArSParticleSource::GeneratePointSource()
{
...
void
LArSParticleSource::GeneratePointsInVolume()
{
...
void
LArSParticleSource::GeneratePointsInSurface()
{
  G4ThreeVector RandPos;
  G4double x = 0., y = 0., z = 0.;
...
G4bool
LArSParticleSource::IsSourceConfined()
{
  ...
  if(theVolume == NULL) G4cout<<"Volume is NULL"<<endl;
...
void
LArSParticleSource::GenerateIsotropicFlux()
{
	G4double rndm, rndm2;
	G4double px, py, pz;
...
void
LArSParticleSource::GenerateMonoEnergetic()
{
	m_dParticleEnergy = m_dMonoEnergy;
}

void
LArSParticleSource::GenerateEnergyFromSpectrum()
{
	m_dParticleEnergy = m_hEnergySpectrum.GetRandom()*MeV;
}

void
LArSParticleSource::GeneratePrimaryVertex(G4Event * evt)
{
...
void
LArSParticleSource::GeneratePrimaryVertexFromTrack(G4Track *pTrack, G4Event *pEvent)
{
