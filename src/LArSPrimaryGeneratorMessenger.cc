...
LArSPrimaryGeneratorMessenger::LArSPrimaryGeneratorMessenger(LArSPrimaryGeneratorAction *pPrimaryGeneratorAction):
  m_pPrimaryGeneratorAction(pPrimaryGeneratorAction)
{
  G4cout <<"LArSPrimaryGeneratorMessenger:: Define Primary Generator I/O"<<G4endl;
  // create directory
...
LArSPrimaryGeneratorMessenger::~LArSPrimaryGeneratorMessenger()
{
  delete m_pDirectory;
}

void
LArSPrimaryGeneratorMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
