...
LArSParticleSourceMessenger::LArSParticleSourceMessenger(LArSParticleSource *pParticleSource):
...
LArSParticleSourceMessenger::~LArSParticleSourceMessenger()
{
	delete m_pTypeCmd;
	delete m_pShapeCmd;
	delete m_pCenterCmd;
...
void
LArSParticleSourceMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
