...
LArSPhysicsMessenger::LArSPhysicsMessenger(LArSPhysicsList *pPhysicsList):
...
LArSPhysicsMessenger::~LArSPhysicsMessenger()
{
  delete m_pDirectory;
}

void
LArSPhysicsMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
