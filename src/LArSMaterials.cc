...
void LArSMaterials::DefineMaterials() {
    ...
    // Silicon
    G4double b = 28.09*g/mole;
    G4double d = 2.32*g/cm3;
    G4Material *SiliconMaterial = new G4Material("SiliconMaterial", 14., b, d);
    ...
    Gd_LScint->AddMaterial(Gd_carboxylate, 0.003994);  // Makes 0.1% of Gd in mass.
    ...
    Gd_LScint_0_2->AddMaterial(Gd_carboxylate, 0.007989);  // Makes 0.2% of Gd in mass.
    ...
    Gd_LScint_0_4->AddMaterial(Gd_carboxylate, 0.015977);  // Makes 0.4% of Gd in mass.
    ...
    Gd_LScint_0_8->AddMaterial(Gd_carboxylate, 0.031954);  // Makes 0.8% of Gd in mass.
    ...
    G4double pdQuartzPhotonMomentum[iNbEntriesMatch] = {1. * eV, 6.9 * eV, 6.91 * eV, 6.98 * eV, 7.05 * eV};  
    ...
    G4double pdPhotoCathodePhotonMomentum[] = {1. * eV, 6.9 * eV, 6.91 * eV, 6.98 * eV,7.05 * eV};  
    ...
    G4double dAbsortionLength = 3.2323021424 * mm;  
    ...
    G4Material *PMT_material = new G4Material("PMT_material", 1.6138 * g / cm3, 5, kStateSolid);
    ...
    G4Material *SiPM_material = new G4Material("SiPM_material", 0.39 * g / cm3, 2, kStateSolid); 
    SiPM_material->AddMaterial(Quartz, 83.00 * perCent);
    SiPM_material->AddMaterial(SiliconMaterial, 17.00 * perCent);
    //---------------------------------------------------------------------------------
    //------------------------------------ Additional LArS Materials
    //------------------------------------ added by Alex
    //---------------------------------------------------------------------------------
    ...
    //---------------------------------- grid mesh steel ----------------------------------
		...
		G4Material *GridMeshSS316LSteelLXe = new G4Material("GridMeshSS316LSteelLXe", 0.816*g/cm3, 6, kStateSolid); 
		...
		G4double dAbsortionLengthLXe = 1.39*mm; 
		...
		G4Material *GridMeshSS316LSteelGXe = new G4Material("GridMeshSS316LSteelGXe", 0.816*g/cm3, 6, kStateSolid); 
		...
		G4double dAbsortionLengthGXe = 1.39*mm;
		...
		G4double dAbsortionLengthLXeAu = 75.67*mm; 
