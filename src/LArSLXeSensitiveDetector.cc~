...
LArSLXeSensitiveDetector::LArSLXeSensitiveDetector(G4String hName): G4VSensitiveDetector(hName)
{
	collectionName.insert("LArHitsCollection");
}

LArSLXeSensitiveDetector::~LArSLXeSensitiveDetector()
{
}

void LArSLXeSensitiveDetector::Initialize(G4HCofThisEvent* pHitsCollectionOfThisEvent)
{
...
G4bool LArSLXeSensitiveDetector::ProcessHits(G4Step* pStep, G4TouchableHistory *)
{
...
void LArSLXeSensitiveDetector::EndOfEvent(G4HCofThisEvent *){ 
}
