...
LArSPhysicsList::LArSPhysicsList(G4String fName):G4VModularPhysicsList()
{
  VerboseLevel = 0;
  ...
  m_pMessenger = new LArSPhysicsMessenger(this);
  
  G4cout <<"LArSPhysicsList::LArSPhysicsList() EM physics: "<< m_hEMlowEnergyModel << G4endl;
  ...
  if (m_hHadronicModel == "QGSP_BIC_HP") {
    ...
    G4String msg = "LArSPhysicsList::LArSPhysicsList() Available choices for Hadronic Physics are: <QGSP_BIC_HP> <QGSP_BERT_HP>";
  ...
  */
  ...
  if (m_hEMlowEnergyModel == "emstandard") {
    ...
    G4cout <<"LArSPhysicsList::LArSPhysicsList() FATAL: Bad EM physics list chosen: "<<m_hEMlowEnergyModel<<G4endl;
...
LArSPhysicsList::~LArSPhysicsList()
{
  MakePhysicsPlots();
  delete m_pMessenger;
}
...
void LArSPhysicsList::SetCuts()
{
  if(VerboseLevel > 1)
    G4cout << "LArSPhysicsList::SetCuts:";
...
void
LArSPhysicsList::WriteParameter(G4String parName)
{
...
void
LArSPhysicsList::MakePhysicsPlots()
{
  G4cout <<"LArSPhysicsList:: Init directory structure for histogramming..."<<G4endl;
